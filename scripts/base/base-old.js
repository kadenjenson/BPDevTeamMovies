	...
	{ 
		...
		*/
		...
		{ 
			...
			original object */
			var before = (typeof obj === 'object')? JSON.parse(JSON.stringify(obj)) : obj, 
...
(function()
{
	...
	var LayoutBuilder = base.htmlBuilder.extend(
	{
		...
		onUpdate: function(ele, data, prop, callBack)
		{
			...
			switch(typeof callBack)
			{
				...
				case 'function':
					update = function(value) 
					{
						self.updateElement(ele, callBack, value); 
					};
					break;
			}
		 ...
		 * @param {string} value 
		 */
		updateElement: function(ele, callBack, value)
		{
...
(function() 
{
	...
	{ 
		...
		/**
		 * override this do something before setup. 
		 */
...
(function()
{
	...
	{ 
		...
		createRoute: function(settings)
		{
			...
			settings.uri = this.createURI(uri);  
			...
			var watchers = [
				{
					...
					{
						var selected = exact? (value === ele.pathname) : (value.indexOf(ele.pathname) !== -1); 
...
(function(global) 
{
	...
	Atom.extend = function extend(childLayout)
	{
		...
		if(typeof childLayout === 'object')
		{
			...
			{
				return JSON.parse(JSON.stringify(layoutObject));
			}; 
		}
